...
db_path = os.path.abspath(os.path.join(os.path.dirname(__file__), 'database', 'tarefas.db'))
...
def criar():
    ...
    tarefa = Tarefa(conteudo=request.form['conteúdo_tarefa'], feita=False) # id não é necessário atribuí-lo manualmente, porque a primary key gera-se automaticamente
